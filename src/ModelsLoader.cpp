...
namespace Anni
{
	namespace ModelLoader
	{
		...
		void LoadGltf(const std::filesystem::path& file_path, fastgltf::Parser& gltf_parser, std::unique_ptr<Anni::ModelLoader::LoadingResult>& loading_result);
		...
		void LoadSamplers(const fastgltf::Asset& gltf_asset, std::unique_ptr<Anni::ModelLoader::LoadingResult>& loading_result);
		...
		void LoadMaterials(const fastgltf::Asset& gltf_asset, const std::filesystem::path& file_path, std::unique_ptr<Anni::ModelLoader::LoadingResult>& loading_result);
		void LoadMeshes(const fastgltf::Asset& gltf_asset, std::unique_ptr<LoadingResult>& loading_result);
		void LoadSceneNodes(const fastgltf::Asset& gltf_asset, std::unique_ptr<Anni::ModelLoader::LoadingResult>& loading_result);
		void LoadSceneGraph(const fastgltf::Asset& gltf_asset, std::unique_ptr<Anni::ModelLoader::LoadingResult>& loading_result);
		...
		void LoadSamplers(const fastgltf::Asset& gltf_asset, std::unique_ptr<Anni::ModelLoader::LoadingResult>& loading_result)
		{
			...
			{
				Anni::ModelLoader::LoadedSampler loaded_sampler{};
		...
		Anni::ModelLoader::LoadedSampler::AddressMode ExtractAddressMode(const fastgltf::Wrap warp)
		{
			//read the spec, found out this is the way they define this
			switch ( warp )
			{
				case fastgltf::Wrap::ClampToEdge:
					return Anni::ModelLoader::LoadedSampler::AddressMode::ClampToEdge;
				case fastgltf::Wrap::MirroredRepeat:
					return Anni::ModelLoader::LoadedSampler::AddressMode::MirroredRepeat;
				case fastgltf::Wrap::Repeat:
					return Anni::ModelLoader::LoadedSampler::AddressMode::Repeat;
			}
		}

		Anni::ModelLoader::LoadedSampler::SamplerType ExtractMagSamplerType(const fastgltf::Filter filter)
		{
			//read the spec, found out this is the way they define this
			switch ( filter )
			{
				case fastgltf::Filter::Nearest:
					return Anni::ModelLoader::LoadedSampler::SamplerType::Nearest;
				case fastgltf::Filter::Linear:
					return Anni::ModelLoader::LoadedSampler::SamplerType::Linear;
				default:
					return Anni::ModelLoader::LoadedSampler::SamplerType::Nearest;
			}
		}

		Anni::ModelLoader::LoadedSampler::SamplerType ExtractMinSamplerType(const fastgltf::Filter filter)
		{
			switch ( filter )
			{
				case fastgltf::Filter::Nearest:
		...
		Anni::ModelLoader::LoadedSampler::SamplerType Anni::ModelLoader::ExtractMipMapSamplerType(const fastgltf::Filter filter)
		{
		...
		void Anni::ModelLoader::LoadTextureImages(const fastgltf::Asset& gltf_asset, const std::filesystem::path& file_path, std::unique_ptr<LoadingResult>& loading_result)
		{
		...
		void Anni::ModelLoader::LoadMaterials(const fastgltf::Asset& gltf_asset, const std::filesystem::path& file_path, std::unique_ptr<LoadingResult>& loading_result)
		{
		...
		void Anni::ModelLoader::LoadMeshes(const fastgltf::Asset& gltf_asset, std::unique_ptr<LoadingResult>& loading_result)
		{
		...
		void Anni::ModelLoader::LoadSceneNodes(const fastgltf::Asset& gltf_asset, std::unique_ptr<LoadingResult>& loading_result)
		{
		...
		void Anni::ModelLoader::LoadSceneGraph(const fastgltf::Asset& gltf_asset, std::unique_ptr<Anni::ModelLoader::LoadingResult>& loading_result)
		{
			//> LOAD_SCENE_GRAPH
